...
IMPORT_ZIP_FILE = "governance_artifacts.zip"

# See the file cp4d_token.py to learn how to get an autorisation token
access_token = get_bearer_token()

print("---- Import all artifacts from a ZIP File ----")

urlSuffix='/v3/governance_artifact_types/import?merge_option=specified'
headers = {"accept": "application/json", "Authorization" : "Bearer " + access_token}
files = {'file': (IMPORT_ZIP_FILE, open(IMPORT_ZIP_FILE, 'rb'), 'application/zip')}
